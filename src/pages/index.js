        ...
        <Navbar/>
            ...
            <div id = "header">
                <img src="/images/cover.jpg"></img>
                   {/*  <img className="coverPhoto" src='/images/cover.jpg' blurDataURL='/images/cover.jpg' alt = "beach" layout="fill" objectFit="cover" placeholder="blur"/> */}
                    <div className="title">
                            <p>Moments.</p>
                            <p>Enjoyed.</p>
            ...
            <div id = "trips">
                    ...
                    {/*Thailand*/}
                        ...
                        <div  id="excursion"  style={{ display: thailand && fullDay && budget100 ? "flex" : null }}>
                            <Image className="cardImage" src='/elephant2.jpg' alt = "elephant" layout= "fill" blurDataURL='/images/elephant2.jpg' placeholder="blur"/>
